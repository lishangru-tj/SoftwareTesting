    ...
    >
      ...
      <el-table-column align="right">
        ...
        <div style="display:flex;">
          ...
          <el-button @click="clearDustbin()" size="mini" type="danger" style="margin-left:5px;">清空回收站</el-button>
        </div>
        </template>
...
<script>
import { getAllRubbish, restoreOneRubbish, smashAllRubbish, smashOneRubbish } from "@/api/dustbin.js"
export default {
  name: 'Dustbin',
  data () {
    return {
