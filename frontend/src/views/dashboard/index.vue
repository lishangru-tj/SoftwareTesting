<template>
  <div class="dashboard-container">
    <el-card style="width: 100%">
      <div class="dashboard-text" style="margin-left: 20px;">{{ date }}</div>
      <div class="dashboard-box" style="width: 100%" direction="vertical">
        <div style="font-size: 20px;padding-bottom: 10px;">
          {{ welcome }},{{ name }}! 欢迎使用小助手!
        </div>
        <div style="font-size: 15px">如果您是第一次使用我们的系统，下面一些内容将帮助您快速开始:</div>

        <div class="dashboard-boxinsidehor">
          <div class="dashboard-boxinsidever">
            <div style="padding-left: 10px;">新手上路</div>
            <el-button
              type="primary"
