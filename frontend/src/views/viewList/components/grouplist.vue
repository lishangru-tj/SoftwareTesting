<template>
  <div class="mpvlgl_view">
    ...
    >
      ...
      >
        <span
          ...
          class="mpvg_group"
        >
          <span style="padding-left: 20px;" class="mpvg_group_title">{{ group.classificationTitle }}
            <el-button
              size="mini"
              style="margin-bottom: 10px;width:20px;"
              type="danger"
              @click="deleteClassification(group.classificationTitle)"
            ><i class="el-icon-delete" style="margin-left: -7px;"></i></el-button>
          </span>
          <!-- 在该分组新建task -->
          <el-card
    ...
    <el-card class="mpvg_quickCreate_group" style="border:none;margin-top: 38px;width:180px;height:130px">
      <span
...
import { deleteOneClassification, getAllSortedTask, postOneNewClassification } from "@/api/classification.js";
import { patchOneTask, postOneNewTask } from "@/api/task.js";
